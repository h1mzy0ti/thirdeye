...
if inpt == "1":
  ...
  try:
    ...
    print(Fore.WHITE+bold+"ISP :",data['org'])
    print(Fore.WHITE+bold+"City :",data['city'])
    print(Fore.WHITE+bold+"Region :",data['region'])
    print(Fore.WHITE+bold+"Country :",data['country_name'])
    print(Fore.WHITE+bold+"Country Code :",data['country'])
    print(Fore.WHITE+bold+"Capital :",data['country_capital'])
    print(Fore.WHITE+bold+"Postal :",data['postal'])
    print(Fore.WHITE+bold+"Country Calling Code :",data['country_calling_code'])
    print(Fore.WHITE+bold+"Currency Code :",data['currency'])
    print(Fore.WHITE+bold+"Currency Name :",data['currency_name'])
    print(Fore.WHITE+bold+"Country Population :",data['country_population'],"Approx")
